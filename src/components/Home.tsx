        ...
        <div className="flex flex-col min-h-screen">
            <div className="flex-grow flex flex-col justify-center items-center">
                <div className="text-center">
                    ...
                    <p className="mb-6 text-lg text-gray-600">This Ikizamini is here to help you practice and get ready for the theory exam for your provisional driving license.</p>
                    <Link to="/quiz"
